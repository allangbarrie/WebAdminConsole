    ...
    internal class DbInitializer
    {
        ...
        internal static async Task Initialize(AppIdentityDbContext context)
        {
            ...
            var records = new Record[]
            {
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 1, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 1, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 1, CategoryId = 9 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 1, CategoryId = 10 },
                new Record { Time = TimeSpan.Parse("00:55:20"), StageId = 2, CategoryId = 1 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 2, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 2, CategoryId = 8 },
                ...
                new Record { Time = TimeSpan.Parse("01:16:33"), StageId = 3, CategoryId = 2 },
                new Record { Time = TimeSpan.Parse("01:06:23"), StageId = 3, CategoryId = 3 },
                new Record { Time = TimeSpan.Parse("01:19:33"), StageId = 3, CategoryId = 4 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 3, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 3, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 3, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 4, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 4, CategoryId = 8 },
                ...
                new Record { Time = TimeSpan.Parse("01:28:09"), StageId = 5, CategoryId = 2 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 5, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 5, CategoryId = 8 },
                ...
                new Record { Time = TimeSpan.Parse("00:57:47"), StageId = 6, CategoryId = 5 },
                new Record { Time = TimeSpan.Parse("00:59:29"), StageId = 6, CategoryId = 6 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 6, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 6, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 6, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 7, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 7, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 7, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 8, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 8, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 8, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 9, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 9, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 9, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("01:04:25"), StageId = 10, CategoryId = 2 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 10, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 10, CategoryId = 8 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 11, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 11, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 11, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 12, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 12, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 12, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 13, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 13, CategoryId = 8 },
                ...
                new Record { Time = TimeSpan.Parse("01:04:24"), StageId = 14, CategoryId = 2 },
                new Record { Time = TimeSpan.Parse("00:57:22"), StageId = 14, CategoryId = 3 },
                new Record { Time = TimeSpan.Parse("01:14:08"), StageId = 14, CategoryId = 4 },
                new Record { Time = TimeSpan.Parse("01:00:49"), StageId = 14, CategoryId = 5 },
                new Record { Time = TimeSpan.Parse("01:14:08"), StageId = 14, CategoryId = 6 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 14, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 14, CategoryId = 8 },
                ...
                new Record { Time = TimeSpan.Parse("00:59:05"), StageId = 15, CategoryId = 3 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 15, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 15, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 15, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 16, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 16, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 16, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 17, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 17, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 17, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 18, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 18, CategoryId = 8 },
                ...
                new Record { Time = TimeSpan.Parse("00:58:05"), StageId = 19, CategoryId = 5 },
                new Record { Time = TimeSpan.Parse("01:03:19"), StageId = 19, CategoryId = 6 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 19, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 19, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 19, CategoryId = 9 },
                ...
                new Record { Time = TimeSpan.Parse("00:36:47"), StageId = 20, CategoryId = 5 },
                new Record { Time = TimeSpan.Parse("00:40:01"), StageId = 20, CategoryId = 6 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 20, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 20, CategoryId = 8 },
                ...
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 21, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 21, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 21, CategoryId = 9 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 21, CategoryId = 10 },
                ...
                new Record { Time = TimeSpan.Parse("00:42:03"), StageId = 22, CategoryId = 5 },
                new Record { Time = TimeSpan.Parse("00:49:42"), StageId = 22, CategoryId = 6 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 22, CategoryId = 7 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 22, CategoryId = 8 },
                new Record { Time = TimeSpan.Parse("00:00:00"), StageId = 22, CategoryId = 9 },
            ...
            var captain = new Captain[]
            {
                ...
                new Captain { Name = "fraser.murray@bcg.com" },
            ...
            var team = new BulkTeamCreateViewModel[]
            {
                ...
                new BulkTeamCreateViewModel { StartNumber = 45, TeamName = "26.2 RRC 4", CaptainEmail = "contact@richardwkirk.co.uk" },
                new BulkTeamCreateViewModel { StartNumber = 60, TeamName = "BeaRCat Running Club 1", CaptainEmail = "jonlear@hotmail.co.uk" },
                new BulkTeamCreateViewModel { StartNumber = 75, TeamName = "BeaRCat Running Club 2", CaptainEmail = "jonlear@hotmail.co.uk" },
                new BulkTeamCreateViewModel { StartNumber = 90, TeamName = "Beckenham Running Club 1", CaptainEmail = "fletcherpaul90@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 105, TeamName = "Beckenham Running Club 2", CaptainEmail = "fletcherpaul90@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 120, TeamName = "Boston Consulting Group 1", CaptainEmail = "fraser.murray@bcg.com" },
                new BulkTeamCreateViewModel { StartNumber = 135, TeamName = "Boston Consulting Group 2", CaptainEmail = "fraser.murray@bcg.com" },
                ...
                new BulkTeamCreateViewModel { StartNumber = 255, TeamName = "Clapham Pioneers 1", CaptainEmail = "catherine.e.l.hodge@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 270, TeamName = "Clapham Pioneers 2", CaptainEmail = "catherine.e.l.hodge@gmail.com" },
                ...
                new BulkTeamCreateViewModel { StartNumber = 330, TeamName = "Ealing Eagles 1", CaptainEmail = "angeladuff81@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 345, TeamName = "Ealing Eagles 2", CaptainEmail = "angeladuff81@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 360, TeamName = "Ealing Eagles 3", CaptainEmail = "angeladuff81@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 375, TeamName = "Elmbridge", CaptainEmail = "richnicholson@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 390, TeamName = "Hampton Wick Wanderers", CaptainEmail = "jeremy.sharman@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 405, TeamName = "Hillingdon AC", CaptainEmail = "andywood3@hotmail.com" },
                ...
                new BulkTeamCreateViewModel { StartNumber = 480, TeamName = "London Front Runners 5", CaptainEmail = "julianandroman@me.com" },
                new BulkTeamCreateViewModel { StartNumber = 495, TeamName = "Maidenhead AC 1", CaptainEmail = "nick_sille@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 510, TeamName = "Maidenhead AC 2", CaptainEmail = "nick_sille@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 525, TeamName = "Maidenhead AC 3", CaptainEmail = "nick_sille@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 540, TeamName = "Queens Park Harriers", CaptainEmail = "harryhp@hotmail.co.uk" },
                new BulkTeamCreateViewModel { StartNumber = 555, TeamName = "Ranelagh Harriers 1", CaptainEmail = "ranelaghgbr@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 570, TeamName = "Ranelagh Harriers 2", CaptainEmail = "ranelaghgbr@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 585, TeamName = "Ranelagh Harriers 3", CaptainEmail = "ranelaghgbr@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 600, TeamName = "Ranelagh Harriers 4", CaptainEmail = "ranelaghgbr@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 615, TeamName = "Serpentine 1", CaptainEmail = "hanssale4@yahoo.co.uk" },
                new BulkTeamCreateViewModel { StartNumber = 630, TeamName = "Serpentine 2", CaptainEmail = "hanssale4@yahoo.co.uk" },
                new BulkTeamCreateViewModel { StartNumber = 645, TeamName = "Serpentine 3", CaptainEmail = "hanssale4@yahoo.co.uk" },
                new BulkTeamCreateViewModel { StartNumber = 660, TeamName = "SHAEF Shifters", CaptainEmail = "ian.fullen@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 675, TeamName = "Stragglers 1", CaptainEmail = "emily.wattret@googlemail.com" },
                new BulkTeamCreateViewModel { StartNumber = 690, TeamName = "Stragglers 2", CaptainEmail = "emily.wattret@googlemail.com" },
                new BulkTeamCreateViewModel { StartNumber = 705, TeamName = "Stragglers 3", CaptainEmail = "emily.wattret@googlemail.com" },
                new BulkTeamCreateViewModel { StartNumber = 720, TeamName = "Sutton Striders 1", CaptainEmail = "eliselawrenson@yahoo.com" },
                new BulkTeamCreateViewModel { StartNumber = 735, TeamName = "Sutton Striders 2", CaptainEmail = "eliselawrenson@yahoo.com" },
                new BulkTeamCreateViewModel { StartNumber = 750, TeamName = "Thames Hare & Hounds 1", CaptainEmail = "khedgth@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 765, TeamName = "Thames Hare & Hounds 2", CaptainEmail = "khedgth@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 780, TeamName = "Wimbledon Windmilers 1", CaptainEmail = "coherich@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 795, TeamName = "Wimbledon Windmilers 2", CaptainEmail = "coherich@gmail.com" }
            };
        ...
        internal static async Task SeedCaptains(AppIdentityDbContext context)
        {
            ...
            foreach (BulkTeamCreateViewModel s in team)
            {
                ...
                {
                    var password = new PasswordHasher<AppUser>();
                    var hashed = password.HashPassword(user, "GBRC4pta!n2024");
                    user.PasswordHash = hashed;
                    var userStore = new UserStore<AppUser>(context);
                    await userStore.CreateAsync(user);
