    ...
    internal class DbInitializer
    {
        ...
        internal static async Task Initialize(AppIdentityDbContext context)
        {
            ...
            var team = new BulkTeamCreateViewModel[]
            {
                ...
                new BulkTeamCreateViewModel { StartNumber = 75, TeamName = "Beckenham Running Club 1", CaptainEmail = "allangbarrie@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 90, TeamName = "Beckenham Running Club 2", CaptainEmail = "allangbarrie@gmail.com" },
