    ...
    internal class DbInitializer
    {
        ...
        internal static async Task Initialize(AppIdentityDbContext context)
        {
            ...
            var team = new BulkTeamCreateViewModel[]
            {
                ...
                new BulkTeamCreateViewModel { StartNumber = 75, TeamName ="Beckenham Running Club 1", CaptainEmail = "Peter Hanslip peterhanslip@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 90, TeamName ="Beckenham Running Club 2", CaptainEmail = "Peter Hanslip peterhanslip@hotmail.com" },
                ...
                new BulkTeamCreateViewModel { StartNumber = 330, TeamName ="Ealing Eagles 1", CaptainEmail = "terena.dbh@mac.com" },
                new BulkTeamCreateViewModel { StartNumber = 345, TeamName ="Ealing Eagles 2", CaptainEmail = "terena.dbh@mac.com" },
                new BulkTeamCreateViewModel { StartNumber = 360, TeamName ="Elmbridge 1", CaptainEmail = "richnicholson@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 375, TeamName ="Elmbridge 2", CaptainEmail = "richnicholson@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 390, TeamName ="Epsom & Ewell Harriers", CaptainEmail = "email@nhenderson.com" },
                new BulkTeamCreateViewModel { StartNumber = 405, TeamName ="Hampton Wick Wanderers", CaptainEmail = "colinmuir@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 420, TeamName ="Havering 90", CaptainEmail = "melgreenwoods@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 435, TeamName ="Hersham Hounds", CaptainEmail = "sjbelliott41@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 450, TeamName ="Hillingdon AC", CaptainEmail = "andywood3@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 465, TeamName ="London Front Runners 1", CaptainEmail = "julianandroman@me.com" },
                new BulkTeamCreateViewModel { StartNumber = 480, TeamName ="London Front Runners 2", CaptainEmail = "julianandroman@me.com" },
                new BulkTeamCreateViewModel { StartNumber = 495, TeamName ="London Front Runners 3", CaptainEmail = "julianandroman@me.com" },
                new BulkTeamCreateViewModel { StartNumber = 510, TeamName ="London Front Runners 4", CaptainEmail = "julianandroman@me.com" },
                new BulkTeamCreateViewModel { StartNumber = 525, TeamName ="Maidenhead AC 1", CaptainEmail = "nick_sille@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 540, TeamName ="Maidenhead AC 2", CaptainEmail = "nick_sille@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 555, TeamName ="Maidenhead AC 3", CaptainEmail = "nick_sille@hotmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 570, TeamName ="Paddock Wood AC", CaptainEmail = "steve.wright@kelsey.co.uk" },
                new BulkTeamCreateViewModel { StartNumber = 585, TeamName ="Queens Park Harriers", CaptainEmail = "green.belt.relay@queensparkharriers.org.uk" },
                new BulkTeamCreateViewModel { StartNumber = 600, TeamName ="Ranelagh Harriers 1", CaptainEmail = "ranelaghgbr@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 615, TeamName ="Ranelagh Harriers 2", CaptainEmail = "ranelaghgbr@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 630, TeamName ="Ranelagh Harriers 3", CaptainEmail = "ranelaghgbr@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 645, TeamName ="Ranelagh Harriers 4", CaptainEmail = "ranelaghgbr@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 660, TeamName ="Serpentine 1", CaptainEmail = "fwomelsdorf@web.de" },
                new BulkTeamCreateViewModel { StartNumber = 675, TeamName ="Serpentine 2", CaptainEmail = "fwomelsdorf@web.de" },
                new BulkTeamCreateViewModel { StartNumber = 690, TeamName ="Serpentine 3", CaptainEmail = "fwomelsdorf@web.de" },
                new BulkTeamCreateViewModel { StartNumber = 705, TeamName ="St Albans Striders", CaptainEmail = "hollie.ryder@outlook.com" },
                new BulkTeamCreateViewModel { StartNumber = 720, TeamName ="Stragglers 1", CaptainEmail = "jsaingold@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 735, TeamName ="Stragglers 2", CaptainEmail = "jsaingold@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 750, TeamName ="Stragglers 3", CaptainEmail = "jsaingold@gmail.com" },
                new BulkTeamCreateViewModel { StartNumber = 765, TeamName ="Sutton Striders 1", CaptainEmail = "grahamhannay@googlemail.com" },
                new BulkTeamCreateViewModel { StartNumber = 780, TeamName ="Sutton Striders 2", CaptainEmail = "grahamhannay@googlemail.com" },
